...
export function buildTheatreDemoDirectorModel(
    ...
    return {
        ...
        cues: [
            ...
            cue('correlate-evidence', 'Correlate immutable fixture evidence', 2.0, 'thermal', 'reactor-transport', [7.2, 3.4, 9.5], [-0.1, 0.05, 0], 0.12,
                'Compare axial partition, synthetic thermal constraints, and engine-system channels as separate evidence questions.',
                'Use the unchanged fixtures to identify the MCNP-, MOOSE-, and ROCETS-like records needed to investigate the limit.',
