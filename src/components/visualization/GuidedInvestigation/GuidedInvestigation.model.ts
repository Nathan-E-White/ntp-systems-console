...
export function buildGuidedInvestigationModel(): GuidedInvestigationModel {
    return {
        ...
        boundary: {
            scope: 'Catalogs component identity and maps Active Case evidence selection to immutable evidence views.',
            owns: ['component identity', 'evidence-view routing'],
            excludes: ['reviewer interaction state', 'engineering calculations', 'fixture mutation', 'section navigation'],
        },
    };
}
